      ...
      <div className="container">
        <div className="grid auto-cols-fr grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 lg:gap-x-16">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p>
              Discover the fresh, high-quality crops grown with dedication and
              sustainable practices at Firas Sunrise Farms.
            </p>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p>
              Explore our seasonal harvest and place your order directly from
