      ...
      <section id="intro" className="bg-[#f7f4e8] place-items-centr min-h-screen  py-[clamp(3rem,6vw,5rem)] px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-center gap-10">
          ...
          <div className="flex items-center justify-center ">
            <motion.img 
              className='rounded-t-2xl min-h-72' 
              src="./assets/images/Cows And Sunsets.jpg" 
              alt="Farm scene at sunrise" 
              variants={fadeIn('center', 0.55)}
              initial="hidden"
              whileInView="show"
              exit="hidden"
            />
